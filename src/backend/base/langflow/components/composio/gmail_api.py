...
class GmailAPIComponent(LCToolComponent):
    ...
    description: str = "Use gmail actions with your agent"
    name = "gmailAPI"
    icon = "gmail"
            ...
            try:
                ...
                if build_config["auth_status"]["value"] == "✅":
                    ...
                    gmail_actions = [
                        ...
                        if action_name.lower().startswith("gmail_")
                    ]
                    if build_config["action_names"]["options"] != gmail_actions:
                        build_config["action_names"]["options"] = gmail_actions
                        build_config["action_names"]["value"] = [gmail_actions[0]] if gmail_actions else [""]
